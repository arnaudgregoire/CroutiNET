...
scores.csv :The first is scores of each points (in .csv)
...
scores_dir = os.path.join(base_dir, "scores.csv")
merged_dir = os.path.join(base_dir, "merged.csv")
...
roadsDF = pd.DataFrame(roads_result, None, ['road_segment', 'long', 'lat', 'heading', 'id'])
