...
#Define Directories
baseDir = r"D:\Arnaud\data_croutinet\paris"
roadsDir = os.path.join(baseDir, "roads")
bestModel = r"D:\Arnaud\data_croutinet\ottawa\data\models\scoreNetworkNoSigmoid.h5"
scoreSave = os.path.join(baseDir,"scores.csv")

#We load all roads pictues names of paris
